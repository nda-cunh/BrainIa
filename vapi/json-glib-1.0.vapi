...
namespace Json {
	...
	public class Array {
		...
		public Array.sized_new (uint n_elements);
		public void unref ();
	}
	...
	[CCode (cheader_filename = "json-glib/json-glib.h")]
	[Version (deprecated = true, deprecated_since = "0.10", since = "0.4")]
	...
	[CCode (cheader_filename = "json-glib/json-glib.h")]
	[Version (since = "0.10")]
	public static GLib.Object? gobject_from_data (GLib.Type gtype, string data, ssize_t length) throws GLib.Error;
	[CCode (cheader_filename = "json-glib/json-glib.h")]
	[Version (since = "0.10")]
